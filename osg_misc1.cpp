...
private:
    ...
    osg::ref_ptr<osg::MatrixTransform> createShootingTarget()
    {
        ...
        osg::ref_ptr<osg::Geode> shootingTargetGeode = new osg::Geode;
        shootingTargetGeode->addDrawable(redCylinder);
        shootingTargetGeode->addDrawable(blueCylinder);
        shootingTargetGeode->addDrawable(yellowCylinder);
        shootingTargetGeode->addDrawable(stickDrawable);
        osg::ref_ptr<osg::MatrixTransform> matrixTransform = new osg::MatrixTransform;
        matrixTransform->addChild(shootingTargetGeode);
